...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, MO(MS),  SH_SPC,           SH_SPC,  SH_SPC,  KC_RALT, TP_LEFT, TP_LEFT, TP_DOWN, TP_RGHT
  ),
  ...
  [MOUSE] = LAYOUT(
    ...
    _______, _______, KC_MS_U, _______, _______, _______, _______, KC_WH_U, _______, _______, _______, _______, _______, _______, \
    ...
    KC_TILD, _______, _______, _______, KC_BTN1,          _______, KC_BTN2, _______, KC_MS_L, KC_MS_L, KC_MS_D, KC_MS_R
  )
